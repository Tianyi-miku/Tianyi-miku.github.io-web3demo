...
export interface RandomNumberlotteryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "getNumberOfRequests"
...
export interface RandomNumberlottery extends BaseContract {
  connect(runner?: ContractRunner | null): RandomNumberlottery;
  waitForDeployment(): Promise<this>;

  interface: RandomNumberlotteryInterface;
